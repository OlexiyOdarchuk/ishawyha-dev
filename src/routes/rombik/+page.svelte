<script lang="ts">
  ...
  import {
    ...
    CreditCard, BarChart3, ShieldCheck, Globe, Cpu, Boxes, Sparkles, Rows3
  } from 'lucide-svelte';
  ...
  const featureIcons = [ShieldCheck, Languages, Rows3, FileDown, Layers, Workflow, SlidersHorizontal, Sparkles];
