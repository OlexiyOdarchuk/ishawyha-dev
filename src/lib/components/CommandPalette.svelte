<script lang="ts">
  ...
  const commands = $derived<Cmd[]>([
    ...
    { id: 'goto-rombik',       title: $t.palette.gotoRombik,       keywords: 'rombik flowchart блок-схема структограма structogram nassi shneiderman dstu iso 5807 saas product api cli mcp', run: () => nav('/rombik') },
